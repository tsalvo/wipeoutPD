...
#define UPDATE_TIME_INITIAL   (200.0F * (1.0F/30.0F))
#define UPDATE_TIME_THREE     (150.0F * (1.0F/30.0F))
#define UPDATE_TIME_RACE_VIEW (100.0F * (1.0F/30.0F))
#define UPDATE_TIME_TWO       (100.0F * (1.0F/30.0F))
#define UPDATE_TIME_ONE       ( 50.0F * (1.0F/30.0F))
#define UPDATE_TIME_GO        (  0.0F * (1.0F/30.0F))


// Physics conversion

#define FIXED_TO_FLOAT(V) ((V) * (1.0F/4096.0F))
#define ANGLE_NORM_TO_RADIAN(V) ((V) * M_PIF * 2.0F)
#define NTSC_STEP_TO_RATE_PER_SECOND(V) ((V) * 30.0F)
...
#define PITCH_VELOCITY(V) ((V) * (1.0F/16.0F))
#define YAW_VELOCITY(V) ((V) * (1.0F/64.0F))
#define ROLL_VELOCITY(V) ((V) * (1.0F))

#define SHIP_FLYING_GRAVITY   80000.0F
#define SHIP_ON_TRACK_GRAVITY 30000.0F
#define SHIP_MIN_RESISTANCE 	20.0F	 // 12
#define SHIP_MAX_RESISTANCE 	74.0F
#define SHIP_VELOCITY_SHIFT 	6
#define SHIP_TRACK_MAGNET		64	// 64
#define SHIP_TRACK_FLOAT 	256

#define SHIP_PITCH_ACCEL    NTSC_ACCELERATION(ANGLE_NORM_TO_RADIAN(FIXED_TO_FLOAT(PITCH_VELOCITY(30.0F))))
